...
public class UserActivity extends Activity {
    ...
    {
        Date dtNascimento = new Date(2018,9,1);
        ...
        Usuario usuario = new Usuario("Carlão", dtNascimento, nivelSelecionado.ordinal(), idiomaSelecionado.getSigla());
        ...
        mRef.setValue(usuario).addOnCompleteListener(UserActivity.this, new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()) {
                    ...
                    Toast.makeText(UserActivity.this, "Erro ao salvar o usuário", Toast.LENGTH_SHORT).show();
                }
            }
        });
